...
def main():
    ...
    if degree == 2:
        ...
        if discriminant > 0:
            ...
            print(f"{x1:.6g}")
            print(f"{x2:.6g}")
        elif abs(discriminant) < epsilon:  # Handling near-zero due to floating-point
            x = -b / (2 * a)
            ...
            if real_part_str == '0':
                ...
                sol1 = f"{real_part_str} + {imaginary_str}i" if imaginary_part >=0 else f"{real_part_str} - {imaginary_str}i"
                sol2 = f"{real_part_str} - {imaginary_str}i" if imaginary_part >=0 else f"{real_part_str} + {imaginary_str}i"
